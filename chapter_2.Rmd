...
Oil <- function(t, y, params) {
  with(as.list(c(y, params)), {
    dFV <- (VProductionRate - (1-(POS/1e7)) * FV)
    dPOS <- (OProdRate - (OConsRate)*FV)
    dURCO <- -OProdRate
...
state <- c(FV = 0, POS = 1e7, URCO = 1e8)
parms <- c(VProductionRate = 1e4, VObsolescenceRate = 0.05, OProdRate = 1e5, OConsRate = 0.1)
